...
import com.doravantesoft.catalago.services.ProductService;
...
public class ProductResourceTests {
	...
	@Test
	public void isertShouldReturnCreatedAndProductDTO() throws Exception{
		
		String jsonBody = objectMapper.writeValueAsString(productDTO);
		
		ResultActions result = mockMvc.perform(post("/products").contentType(MediaType.APPLICATION_JSON).content(jsonBody).accept(MediaType.APPLICATION_JSON));
...
String jsonBody = objectMapper.writeValueAsString(productDTO);
	...
	@Test
	public void findByIdShouldreturnWhenIdExists() throws Exception {
	...
	@Test
	public void findByIdShouldThrowsNotFoundWhenIdDoesNotExist() throws Exception{
